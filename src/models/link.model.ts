...
export const shortenURL = async (userID: string, originalURL: string, title: string, description: string, category: string):
...
export const getOriginalURL = async (shortID: string): Promise<ILink | null | undefined> => {
    try {
        await connectDB();
...
export const findMyURLs = async (userID: string): Promise<ILink[] | null | undefined> => {
    try {
        await connectDB();
...
export const deleteURL = async (linkID: string): Promise<void> => {
    try {
        await connectDB();
